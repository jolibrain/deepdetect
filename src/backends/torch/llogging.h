...
#undef TORCH_DCHECK_OP
#undef TORCH_CHECK_EQ
#undef TORCH_CHECK_NE
#undef TORCH_CHECK_LE
#undef TORCH_CHECK_LT
#undef TORCH_CHECK_GE
#undef TORCH_CHECK_GT
#undef TORCH_DCHECK_EQ
#undef TORCH_DCHECK_NE
#undef TORCH_DCHECK_LE
#undef TORCH_DCHECK_LT
#undef TORCH_DCHECK_GE
#undef TORCH_DCHECK_GT
