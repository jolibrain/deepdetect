...
for (let i = 0; i < x.length; i++) {
  ...
  ReactDOM.render(<App service={service} imageList={imageList} confidenceThreshold={confidenceThreshold} best={x[i].dataset.best} thresholdControl={thresholdControl}/>, x[i]);
