...
set(deepdetect_known_gpu_archs "20 21(20) 30 35 50 61 75 86")

################################################################################################
# A function for automatic detection of GPUs installed  (if autodetection is enabled)
# Usage:
#   deepdetect_detect_installed_gpus(out_variable)
function(deepdetect_detect_installed_gpus out_variable)
  ...
  if(NOT CUDA_gpu_detect_output)
    ...
    set(${out_variable} ${deepdetect_known_gpu_archs} PARENT_SCOPE)
  else()
    set(${out_variable} ${CUDA_gpu_detect_output} PARENT_SCOPE)
  endif()
endfunction()

macro(deepdetect_list_unique)
  foreach(__lst ${ARGN})
    if(${__lst})
...
function(deepdetect_select_nvcc_arch_flags out_variable out_arch)
  ...
  if(${CUDA_ARCH_NAME} STREQUAL "Manual")
    set(CUDA_ARCH_BIN ${deepdetect_known_gpu_archs} CACHE STRING "Specify 'real' GPU architectures to build binaries for, BIN(PTX) format is supported")
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "All")
    set(__cuda_arch_bin ${deepdetect_known_gpu_archs})
  elseif(${CUDA_ARCH_NAME} STREQUAL "Auto")
    deepdetect_detect_installed_gpus(__cuda_arch_bin)
  ...
  deepdetect_list_unique(__cuda_arch_bin __cuda_arch_ptx)
...
list(APPEND deepdetect_LINKER_LIBS ${CUDA_CUDART_LIBRARY}
...
if(USE_CUDNN)
  ...
  if(HAVE_CUDNN)
    ...
    list(APPEND deepdetect_LINKER_LIBS ${CUDNN_LIBRARY})
  endif()
endif()
...
if(APPLE)
  deepdetect_detect_darwin_version(OSX_VERSION)
  ...
  if(OSX_VERSION VERSION_GREATER 10.8)
    ...
    deepdetect_option(USE_libstdcpp "Use libstdc++ instead of libc++" (CUDA_VERSION VERSION_LESS 7.0))
  endif()
endif()
