...
var Predict = __webpack_require__(31);
...
var Service = function () {
  ...
  _createClass(Service, [{
    ...
    key: '_init',
    value: function _init(apiEndpoint) {
...
module.exports = {
	"name": "deepdetect-js",
	"version": "1.0.0",
	"description": "A JS library for deepdetect",
	"main": "dist/index.js",
	"repository": {},
	...
	"scripts": {
		...
		"test": "./node_modules/mocha/bin/mocha spec/node-test.js",
		"lint": "eslint --ignore-pattern **/deepdetect.js --ext .js src/**"
	},
	"devDependencies": {
		"babel-core": "^6.22.1",
		"babel-eslint": "^7.1.1",
...
var Predict = function () {
  ...
  _createClass(Predict, [{
    ...
    value: function post(params) {
      var url = '' + this._config.apiEndpoint + API.PREDICT;
      return new Promise(function (resolve, reject) {
